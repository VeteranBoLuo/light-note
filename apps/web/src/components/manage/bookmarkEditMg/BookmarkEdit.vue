        ...
        <div class="tag-attr-item">
          <div class="tag-attr-head">
            ...
            <div class="tag-attr-actions">
              ...
              <span v-if="isEdit && bookmarkData.hasSnapshot" class="bm-badge bm-badge--snap">📄 {{ $t('bookmarkMg.badgeArchived') }}</span>
              <span v-if="isEdit && bookmarkData.hasSummary" class="bm-badge bm-badge--sum">🤖 {{ $t('bookmarkMg.badgeSummary') }}</span>
            </div>
          </div>
