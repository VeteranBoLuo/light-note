...
<style lang="less">
  ...
  .note-editor .tox .tox-edit-area__iframe {
    background-color: var(--workspace-content) !important;
  }
  [data-theme='night'] {
    .note-editor-toolbar {
  ...
  .note-editor-runtime-skeleton, .note-editor-rich-content {
