...
<script setup lang="ts">
  ...
  const descriptions: Record<string, string> = {
    ...
    completed: '全部条目真实回顾并到账 5 EXP 后的紧凑完成态。',
    'completed-partial': '受每日上限影响，只实际到账 2 EXP 的完成态。',
    'completed-cap': '全部条目真实回顾，但今日经验已达上限的完成态。',
    'completed-processed': '通过打开、延后和屏蔽混合处理完成，不获得回顾奖励。',
