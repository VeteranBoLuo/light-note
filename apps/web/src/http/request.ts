...
export const apiBasePatch = async (url: string, data?: any, options?: RequestOptions): Promise<ApiResponse> => {
  const res = await request({
    url,
    method: 'patch',
    data,
...
export const apiBaseDelete = async (url: string, data?: any, options?: RequestOptions): Promise<ApiResponse> => {
  const res = await request({
    url,
    method: 'delete',
    data,
