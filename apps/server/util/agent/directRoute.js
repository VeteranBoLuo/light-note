const RESOURCE_OR_ACTION_PATTERN =
  /(?:我的|我有|轻笺|笔记|书签|收藏夹|文件|云空间|文件夹|标签|回收站|AI\s*额度|等级|经验|积分|通知|设备|反馈|用户|日志|安全|后台|管理员|数据库|今日|今天|最近|本周|上周|本月|上月|多少(?:条|个|篇|次)?|统计|查询|搜索|查找|列出|读取|打开|收藏|保存|创建|新建|恢复|删除|上传|归档|整理到|https?:\/\/|www\.)/i;
