...
declare(ADMIN_POLICIES.CONTENT_WRITE, 'file', [
  ...
  ['POST', '/file/moveFolder'],
  ['POST', '/file/deleteFolder'],
  ['POST', '/file/clearFolderFiles'],
...
declare(ADMIN_POLICIES.ACCOUNT_WRITE, 'user', [
  ...
  ['POST', '/user/dataExports/create'],
  ['POST', '/user/dataExports/latest'],
  ['POST', '/user/dataExports/detail'],
  ['POST', '/user/dataExports/cancel'],
  ['POST', '/user/dataExports/failures'],
  ['GET', '/user/dataExports/download/:id'],
...
declare(ADMIN_POLICIES.READ, 'agent', [
  ['POST', '/chat/aiQuota'],
  ['POST', '/chat/aiUsage'],
  ['POST', '/chat/aiUsageDetail'],
]);

declare(ADMIN_POLICIES.ADMIN_ONLY, 'admin', [
  ['POST', '/admin/ai-operations/overview'],
  ['POST', '/admin/ai-operations/executions/query'],
  ['POST', '/admin/ai-operations/executions/detail'],
  ...
  ['POST', '/common/getAdminFilePreviewDiagnostic'],
