...
SET @ai_source_help_content = '<h2>什么是参考来源</h2><p>轻笺智域在读取你的资源或轻笺知识库后，会在回答下方显示“参考来源”。来源卡片保留资源类型、名称和必要摘录，帮助你核对回答依据。只有本轮实际读取或操作过的资源才会进入来源列表。</p><h2>哪些来源可以点击</h2><ul><li><b>帮助中心文章</b>：在轻笺内打开对应文章，地址栏带文章 ID；刷新、复制链接或前进后退后仍能保留当前文章。</li><li><b>公开知识</b>：打开对应的公开知识详情页。</li><li><b>笔记</b>：进入对应笔记详情。</li><li><b>书签</b>：正常链接优先打开原网页；死链但已有正文快照时打开快照；没有可打开网址时进入书签编辑页。</li><li><b>云文件与 AI 文档</b>：已保存到云空间的文件按文件 ID 精确打开预览；临时上传文档仅在只读预览地址仍有效时可打开。</li><li><b>云文件夹与标签</b>：分别进入对应文件夹或标签详情。</li><li><b>网页检索结果</b>：打开本轮读取的 HTTP/HTTPS 网页。</li></ul><h2>为什么有些来源不能点击</h2><p>来源缺少稳定 ID、临时预览地址已过期、网址协议不安全，或资源已删除、无权访问时，卡片会保持只读或提示不可用，不会猜测并跳转到其他资源。轻笺会在服务端校验资源归属；来源卡片不会绕过原有权限。</p><h2>旧会话兼容</h2><p>升级前保存在当前浏览器里的帮助来源可能没有文章 ID。再次进入对话时，轻笺会按完整标题精确匹配并补齐公开文章标识；无法唯一确认的旧来源仍保持只读，避免跳错内容。</p>';
