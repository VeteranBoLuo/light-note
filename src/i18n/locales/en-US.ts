export default {
  ...
  resourceCenter: {
    ...
    subtitle: 'Search bookmarks, notes, cloud files, and tags together to quickly find the content you keep in LightNote.',
  ...
  personCenter: {
    ...
    opinions: {
      ...
      exampleDesc: 'For example: editing tags fails in bookmark management, or you want a recent items section on the home page.',
  ...
  tagManage: {
    ...
    subtitle: 'Manage your unified tag system like a resource hub and quickly review the bookmarks, notes, and files linked to each tag.',
    filtersTitle: 'Views',
