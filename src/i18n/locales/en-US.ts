export default {
  ...
  workbench: {
    title: 'Workbench',
    subtitle: 'Aggregate bookmark, note, file, and tag states for faster daily actions.',
    summary: {
    ...
    actions: {
      ...
      addTag: { label: 'New Tag', desc: 'Create category tag' },
      ...
      tagManage: { label: 'Tag Mgmt', desc: 'Maintain tag system' },
