export default {
  ...
  ai: {
    ...
    quickNote: 'Quick note: meeting at 10am tomorrow',
    addTag: 'Add "important" tag to my AI note',
    restoreTrash: "Restore yesterday's deleted bookmarks",
    crossSearch: 'Search bookmarks and notes about "design"',
