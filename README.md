...
轻笺把书签、笔记、云文件和待办放在同一个账号下，用标签和搜索找回资料，继续编辑或处理下一步行动。

核心资料管理功能免费使用；AI 与云空间有额度限制，额外资源权益以站内资源商店说明为准。自愿支持不作为使用现有免费功能的门槛。
...
2. 注册或登录自己的账号
3. 先保存一份自己的资料，再打开它确认成功；下次按名称找回并继续使用。

[从保存到找回：入门与浏览器扩展指南](docs/getting-started.md)
